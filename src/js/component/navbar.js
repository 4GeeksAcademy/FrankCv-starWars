...
export const Navbar = () => {
	...
	return (
		<nav className="navbar navbar-light mb-3 px-5" style={{ backgroundColor: '' }}>
			<Link to="/">
				<img style={{ width: "10vw", minWidth: "100px" }} src="https://upload.wikimedia.org/wikipedia/commons/5/5a/Star_Wars_Logo..png" className="rounded float-start ms-5 ps-5" alt="..." />
			</Link>
